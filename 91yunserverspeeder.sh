...
#bin下载地址
BIN=http://soft.91yun.org/soft/serverspeeder/bin/Ubuntu/14.10/4.0.2-x86_64-linode56/x64/3.10.61.0/serverspeeder_2730
...
rv=Ubuntu_14.10_4.0.2-x86_64-linode56
...
echo "开始下载bin运行文件。。。。"
echo "======================================"
curl $BIN -o 91yunserverspeeder/apxfiles/bin/acce-3.10.61.0-[Ubuntu_14.10_4.0.2-x86_64-linode56] || { echo "下载bin运行文件失败，请检查";exit 1; }
